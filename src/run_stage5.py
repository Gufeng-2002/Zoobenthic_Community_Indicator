...
Reads  : results/01_pollution_assessment/artifacts/01_updated_data.xlsx
         results/03_LDA_Classification/artifacts/03_updated_data.xlsx
         results/04_bray_curtis_NMDS/artifacts/04_updated_data.xlsx
Writes : results/05_piecewise_qr/tables/  (qr_coefficients, sensitivity)
         results/05_piecewise_qr/figures/ (ci_errorbars, three_quantiles,
                                            sensitivity, coverage)
         results/05_piecewise_qr/artifacts/05_updated_data.xlsx
"""
...
STAGE4_ARTIFACT = PROJECT_ROOT / "results" / "04_bray_curtis_NMDS" / "artifacts" / "04_updated_data.xlsx"
