...
Writes : results2/RDA_analysis/tables/  (rda_axes_summary, rda_terms_summary)
         results2/RDA_analysis/figures/ (rda_triplot)
"""
...
OUTPUT_DIR      = PROJECT_ROOT / "results2" / "RDA_analysis"
