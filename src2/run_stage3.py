...
Reads  : data/processed/complete_env_taxa_chemical_Feb_3.xlsx
         ...
         results2/02_taxa_assemblage/artifacts/02_hindsight_updated_data.xlsx
Writes : results2/03_LDA_Classification/tables/  (6 tables)
         results2/03_LDA_Classification/figures/ (lda_triplot, cluster_comparison)
...
STAGE2_ARTIFACT = PROJECT_ROOT / "results2" / "02_taxa_assemblage" / "artifacts" / "02_hindsight_updated_data.xlsx"
OUTPUT_DIR      = PROJECT_ROOT / "results2" / "03_LDA_Classification"
