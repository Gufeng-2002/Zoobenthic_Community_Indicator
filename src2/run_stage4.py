...
Writes : results2/04_bray_curtis_NMDS/tables/  (nmds_summary, zci_summary)
         results2/04_bray_curtis_NMDS/figures/ (nmds_biplot, zci_distribution,
                                                zci_vs_pollution)
...
OUTPUT_DIR      = PROJECT_ROOT / "results2" / "04_bray_curtis_NMDS"
