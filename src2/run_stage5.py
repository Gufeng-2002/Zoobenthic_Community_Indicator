#!/usr/bin/env python
"""
Run Stage 5: Piecewise Quantile Regression with Wild-Bootstrap CIs
===================================================================

Usage (from project root):
    python src2/run_stage5.py
...
Reads  : results2/01_pollution_assessment/artifacts/01_updated_data.xlsx
         results2/03_LDA_Classification/artifacts/03_updated_data.xlsx
         results2/04_bray_curtis_NMDS/artifacts/04_updated_data.xlsx
Writes : results2/05_piecewise_qr/tables/  (qr_coefficients, sensitivity)
         results2/05_piecewise_qr/figures/ (ci_errorbars, three_quantiles,
                                            sensitivity, coverage)
         results2/05_piecewise_qr/artifacts/05_updated_data.xlsx
"""
...
STAGE3_ARTIFACT = PROJECT_ROOT / "results2" / "03_LDA_Classification" / "artifacts" / "03_updated_data.xlsx"
STAGE4_ARTIFACT = PROJECT_ROOT / "results2" / "04_bray_curtis_NMDS" / "artifacts" / "04_updated_data.xlsx"
OUTPUT_DIR      = PROJECT_ROOT / "results2" / "05_piecewise_qr"
...
if __name__ == "__main__":
    result = pqr_pipeline(
        ...
        n_breakpoints=1,
        taus= list(np.round(np.arange(0.1, 0.91, 0.05), 2)),                   # default 0.10 … 0.90 step 0.05
        highlight_taus=(0.20, 0.50, 0.80),
        n_boot=500,                     # wild-bootstrap replicates
        ...
        sensitivity_fracs=list(np.round(np.arange(0.15, 1.01, 0.03), 2)),         # default 15 % … 100 % step 5 %
